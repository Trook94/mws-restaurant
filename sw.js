...
self.addEventListener('install', function (event){
    event.waitUntil(caches.open(staticCacheName).then(function(cache){
        return cache.addAll(['./', 'index.html' , 'restaurant.html' , 'favicon.ico' ,
        'js/main.js', 'js/restaurant_info.js', 'js/dbhelper.js', 'js\registeration.js' ,
        'css/styles.css',
      ...
      caches.keys().then(function(cacheNames) {
        return Promise.all(
          cacheNames.filter(function(cacheName) {
            return cacheName.startsWith('mws-static-v1') &&
